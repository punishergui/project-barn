...
export type AuthStatus = { role: string | null; is_unlocked: boolean; unlock_expires_at: string | null; is_parent?: boolean; profile_id?: number | null; name?: string | null; requires_pin?: boolean };
